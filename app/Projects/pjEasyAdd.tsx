...
const pjMaps = [
    {
        ...
        pjBio: 'Next js frontend, Using REST countries API, Framer Motion, React Virtualization',
    ...
    },
    {
        ...
        pjBio: 'Car enterprise, Using React js, Headless UI, Framer Motion, and Recharts with a neat DASHBOARD',
        pjPics: carHubImg,
    ...
    },
    {
        ...
        pjBio: 'React JS Frontend Mentor solution, Using a JSON file and Tailwind, Responsive in all screen sizes',
        pjPics: commentImg,
    ...
    },
    {
        ...
        pjPics: Predictor,
        pjStacks: ['HTML', 'CSS', 'JavaScript', 'CSS Keyframes']
    },
    {
        id: 8,
        ...
        pjBio: 'TypeScript, Linear Gradient – a project designed to deepen my TypeScript expertise, focusing on advanced features and efficient coding practices.',
        pjPics: Booker,
