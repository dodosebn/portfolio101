  ...
  return (
    <div className="lg:text-start lg:relative lg:items-start text-center pt-[4.5rem]">
      <section>
        ...
        <h3 className="text-red-950 font-bold text-xl  dark:text-gradient-animated">
          Your next Frontend Developer
        </h3>
        <p>
          I&apos;m a Frontend Developer who loves making website look good and
          work well. I enjoy writing clean code, solving problems, and
          continuously learning to enhance my skills.
        </p>
      </section>
      ...
      <section>
        <h3 className="text-red-950 text-lg dark:text-gradient-animated">
