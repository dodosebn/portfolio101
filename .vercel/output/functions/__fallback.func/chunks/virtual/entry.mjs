...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import('../_/_tanstack-start-manifest_v-BlE7lXdH.mjs');
...
const manifest = { "c9d51a5243700889c80f82ed57a4ce74b25f188e5ebd534c9c64965dc44e8e8d": {
  ...
  importer: () => import('../_/start.server-funcs-8o7h_ZSr.mjs')
  ...
  importer: () => import('../_/demo.punk-songs-Be2hm0Du.mjs')
} };
...
async function loadEntries() {
  const routerEntry = await import('../_/router-CRrnjbt0.mjs').then((n) => n.r);
